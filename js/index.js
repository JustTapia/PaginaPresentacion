...
function init() {
    let stepperAbout = document.getElementById("stepperAboutId");
    stepperAbout.addEventListener("click", animacionA1);

    let stepperResume = document.getElementById("stepperResumeId");
    stepperResume.addEventListener("click", animacionA2);

    let stepperPortfolio = document.getElementById("stepperPortfolioId");
    stepperPortfolio.addEventListener("click", animacionA3);

    let stepperInterests = document.getElementById("stepperInterestsId");
    stepperInterests.addEventListener("click", animacionA4);

    let stepperContact = document.getElementById("stepperContactId");
    stepperContact.addEventListener("click", animacionA5);
    elementoActual = stepperAbout;
